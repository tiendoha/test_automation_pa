...
Locator: locator('a:has-text("Logged in as")')
...
Call log:
  ...
  - waiting for locator('a:has-text("Logged in as")')
...
```ts
  ...
  5   | import { ENV } from '../../configs/env.config';
  6   | import { feature, story, severity, description } from 'allure-js-commons';
  7   | 
  8   | /**
